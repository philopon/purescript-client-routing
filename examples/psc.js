  ...
  return function Wrap2(a,b){
    ...
    var runRouter$prime = function (_345) {
        return function __do() {
            ...
            (function () {
                if (_32.s.notFound instanceof Data_Maybe.Nothing) {
                    return configureImpl(_33, {
                        historyAPI: _32.s.historyAPI
                    });
                };
                if (_32.s.notFound instanceof Data_Maybe.Just) {
                    return configureImpl(_33, {
                        historyAPI: _32.s.historyAPI, 
                        notFound: runCallback(_32.s.notFound.value0)(function (s_1) {
                            return setRouteImpl(_33, s_1);
                        })
                    });
                };
    ...
    var route = function (p) {
        return function (f) {
            return Prelude[">>="](bindRoutingM)(getState)(function (_39) {
                return liftRoutingM(routeImpl(_39.routerInstance, pathesToString(p), f));
            });
        };
    };
    ...
    var param = function (v) {
        return Prelude[">>="](bindRoutingM)(getState)(function (_38) {
            var n = ":v" + Prelude.show(Prelude.showNumber)(_38.variableIndex);
            return Prelude[">>="](bindRoutingM)(liftRoutingM(paramImpl(_38.routerInstance, n, pathToString(v))))(function () {
